...
public class GustSpell extends Spell {
	...
	public GustSpell(Main main, Player caster) {
		super(main, caster, new NamespacedKey(main, "wizards-gustSpell"));
	}
	...
	private void runGustParticles(Snowball missile) {
		BukkitRunnable runnable = new BukkitRunnable() {
			...
			public void run() {
				...
				if(timer >= 2) {
					missile.getWorld().spawnParticle(Particle.ELECTRIC_SPARK, missile.getLocation(), 10, 0.3, 0.3, 0.3, 0, null);
				}
			}
		};
